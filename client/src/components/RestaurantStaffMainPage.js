...
class RestaurantStaffMainPage extends Component {
  ...
  getRestaurantStaffDetails() {
    ...
    axios
      .post(
        "http://localhost:3001/RestaurantStaff/getRestaurantStaffDetails",
        data
      )
      .then((res) =>
        this.setState({ restaurantDetails: res.data[0] }, () => {
          this.getFoodItems();
        })
      );
  }
  ...
  getFoodItems() {
    ...
    axios
      .post("http://localhost:3001/RestaurantStaff/getFoodItems", data)
  ...
  handleSubmit = (event) => {
    ...
    axios
      .post("http://localhost:3001/RestaurantStaff/addFood", newFood)
  ...
  handleUpdate = (event) => {
    ...
    axios
      .post("http://localhost:3001/RestaurantStaff/updateFood", updatedFood)
  ...
  handleDelete = (food) => {
    axios
      .post("http://localhost:3001/RestaurantStaff/deleteFood", food)
    ...
    return (
      <tr key={food.fid}>
        ...
        <td>
          ...
          <Button variant="danger" onClick={() => this.handleDelete(food)}>
            Delete
          </Button>
        </td>
      </tr>
              ...
              <Col>
                ...
                <Form.Control
                  ...
                  defaultValue={parseFloat(
                    this.state.currentFoodItem.price.substring(1)
                  )}
                />
              </Col>
              <Col>
        ...
        <div className="content">
          <div>
            ...
            <Table striped bordered hover>
              ...
              <tbody>{this.state.foodItems.map(this.renderItem)}</tbody>
            </Table>
          </div>
        </div>
      </div>
