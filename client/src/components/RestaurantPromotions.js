...
class RestaurantPromotions extends Component {
  ...
  getPromo() {
    ...
    axios
      .post("http://localhost:3001/RestaurantStaff/getPromo", data)
  ...
  handleSubmit = (event) => {
    ...
    let new_promo = {
      ...
      trigger_value:
        "$" + parseFloat(form.elements.minimum_spending.value).toFixed(2),
      start_time: this.state.startDate._d
        ...
        .replace(/ /g, "-"),
      end_time: this.state.endDate._d
        .toLocaleDateString("en-GB", {
          day: "2-digit",
          month: "short",
          year: "numeric",
    ...
    axios
      .post("http://localhost:3001/RestaurantStaff/addPromo", new_promo)
          ...
          <div className="container">
            ...
            <form onSubmit={this.handleSubmit}>
              <FormGroup>
                ...
                <h1 />
                {this.state.promotion_type === "percent"
                  ? this.renderPercentForm()
                  : this.renderFlatrateForm()}
                <h1 />
            ...
            <Table striped bordered hover>
              ...
              <tbody>{this.state.promos.map(this.renderItem)}</tbody>
            </Table>
          </div>
        </div>
      </div>
